...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn(
          "w-fit bg-popover p-3 [--cell-size:2rem]",
        ...
        nav: cn(
          "absolute top-0 right-0 left-0 flex w-full items-center justify-between gap-1",
        ...
        range_start: cn(
          "rounded-l-[var(--radius)] bg-accent",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn(
          "rounded-r-[var(--radius)] bg-accent",
