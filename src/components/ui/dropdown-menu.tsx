  ...
  return (
    <Menu.Item
      className={cn(
        ...
        "before:absolute before:inset-x-1 before:inset-y-0 before:-z-10 before:rounded-[calc(var(--radius)-4px)] before:bg-transparent before:content-['']",
...
function DropdownMenuCheckboxItemIndicator({
  ...
  return (
    <Menu.CheckboxItemIndicator
      className={cn(
        "ml-auto flex shrink-0 items-center justify-center text-foreground",
        className
      )}
      {...props}
    />
