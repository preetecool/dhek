...
const popupStyles = cn(
  ...
  "max-sm:top-1/2 max-sm:right-4 max-sm:left-4 max-sm:w-[calc(100vw-2rem)] max-sm:max-w-none max-sm:translate-x-0 max-sm:-translate-y-1/2",
...
function AlertDialogClose({ ...props }: AlertDialog.Close.Props) {
  return (
    <AlertDialog.Close data-slot="alert-dialog-close" nativeButton {...props} />
  );
}
