...
const KanbanContext = createContext<KanbanContextValue<KanbanItemProps> | null>(
  null
);
...
>({
  ...
  return (
    <KanbanContext.Provider
      value={contextValue as KanbanContextValue<KanbanItemProps>}
    >
      <DndContext
...
export type KanbanCardListProps<T extends KanbanItemProps = KanbanItemProps> =
  Omit<React.ComponentProps<"div">, "children" | "id"> & {
    id: string;
