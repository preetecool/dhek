...
const buttonVariants = cva(
  [
    ...
    "relative cursor-pointer overflow-hidden border border-transparent shadow-none",
...
function ArrowPointer({
  ...
  const arrowClasses = cn(
    "relative top-0 -mr-2 ml-2 h-2.5 w-3 overflow-visible",
...
interface ButtonRootProps
  ...
  style?:
    | React.CSSProperties
    | ((state: Button.State) => React.CSSProperties | undefined);
  render?:
    | React.ReactElement
    | ((
